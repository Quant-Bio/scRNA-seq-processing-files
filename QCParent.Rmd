...
#-----------------------------ABOUT THE DATASET --------------------------------
  analysed_dataset: "Chen et al lymphoma, 2024"
  dataset_source: "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE245920"
  dir_seurat: "~/public-data/quantbio/scRNA-seq/Lymphoma_Chen_2024/Seurat_lymphoma_chen.rds"
  figure1: "~/public-data/quantbio/scRNA-seq/Lymphoma_Chen_2024/Chen_abstract.png"
  figure1_legend: "Above is the abstract from the Chen et al, 2024 lymphoma single-cell dataset."
  is_list: FALSE
...
#---------------------QUALITY CONTROL AND STANDARDIZATION-----------------------
  ...
  qcs_indent_var: "sample" # Default identity of cells in metadata
  qcs_eval_cell: TRUE
  ...
  qcs_patient_id: "sample" # This will change depending on the experiment
...
#------------------CLUSTERING AND DIFFERNTIAL EXPRESSION------------------------
  ...
  dex_variance_explained: 0.6 # Percentage of variance explained by # of PCs. I have found keeping this around 60% yields the best results but every dataset is different.
...
Data for this analysis was taken from `r params$data_source`

<br>

**Figure 1)** Legend from `r params$analysed_dataset`: `r params$figure1_legend`
