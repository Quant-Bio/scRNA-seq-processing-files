...
#---------------------QUALITY CONTROL AND STANDARDIZATION-----------------------
  ...
  qcs_indent_var: "Subject_Identity" # Default identity of cells in metadata
  qcs_eval_cell: TRUE
  ...
  qcs_patient_id: "Subject_Identity" # This will change depending on the experiment
  ...
  qcs_save_name: "~/public-data/quantbio/scRNA-seq/IPF_adams_2020/Seurat_IPF_adams_QCS.rds" # Name of the file to write new seurat object as
...
#------------------ANNOTATE THE CELLS WITH TYPE AND PHASE-----------------------
  ...
  anno_save_name:  "~/public-data/quantbio/scRNA-seq/IPF_adams_2020/Seurat_IPF_adams_ANNO.rds" # Name of the file to write new seurat object
...
#------------------CLUSTERING AND DIFFERNTIAL EXPRESSION------------------------
  ...
  dex_seurat_save_name: "~/public-data/quantbio/scRNA-seq/IPF_adams_2020/Seurat_IPF_adams_FULLYPROCESSED.rds" # Name of the file to write new seurat object in
  dex_mat_save_name: "~/public-data/quantbio/scRNA-seq/IPF_adams_2020/Seurats_IPF_adams_DEx_output.csv" # Name of the file to write the DE gene list as
---
