...
params:
  ...
  more_authors: ""
  dir_seurat: "Seurat_Breast_Bassez1_MINIATURE.rds"
  QCS: true
  organism: "human"
  ...
  qcs_cc: true
  ANNO: true
  anno_annotation: "HumanAtlas" # current options are HumanAtlas and ImmGenData
  anno_cutoff: 50
  ...
  anno_save_file: "Seurat_annotated.rds"
  ...
  dex_mat_save_file: "DEx_mat.csv"
  dex_min_pct: 0.25
  dex_variance_explained: 0.8
  dex_run_dex: false
  dex_only_positive: true ### If you want only positive, use this.
