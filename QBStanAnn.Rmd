...
output:
  rmdformats::readthedown: 
      ...
      toc_depth: 5
params:
  analysed_dataset: "Liu et al Ankylosating Spondylitis"
  more_authors: "Rosa Hernansaiz, Vincent Perez, and Jen Modliszewski"
  dir_seurat: "~/public-data/quantbio/scRNA-seq/Ankylosating_spondylitis_Liu_2022/PBMC_SeuratMerged_GEXonly.rds"
  is_list: FALSE
...
#---------------------QUALITY CONTROL AND STANDARDIZATION-----------------------
  ...
  qcs_indent_var: "Subject" # Default identity of cells in metadata
  qcs_eval_cell: TRUE
  ...
  qcs_patient_id: "Subject" # This will change depending on the experiment
  ...
  qcs_save_name: "~/public-data/quantbio/scRNA-seq/Ankylosating_spondylitis_Liu_2022/Seurat_GEXonly_QCS.rds" # Name of the file to write new seurat object as
...
#------------------ANNOTATE THE CELLS WITH TYPE AND PHASE-----------------------
  ...
  anno_save_name:  "~/public-data/quantbio/scRNA-seq/Ankylosating_spondylitis_Liu_2022/Seurat_GEXonly_ANNO.rds" # Name of the file to write new seurat object
  
#------------------CLUSTERING AND DIFFERNTIAL EXPRESSION------------------------
  DEx: TRUE # Set true if you want to run this section
  dex_confounding: FALSE # Set true if you want to check for confounding variables
  ...
  dex_seurat_save_name: "~/public-data/quantbio/scRNA-seq/Ankylosating_spondylitis_Liu_2022/Seurat_GEXonly_FULLYPROCESSED.rds" # Name of the file to write new seurat object in
  dex_mat_save_name: "~/public-data/quantbio/scRNA-seq/Ankylosating_spondylitis_Liu_2022/Seurat_GEXonly_FULLYPROCESSED_DEx_output.rds" # Name of the file to write the DE gene list as
---
...
knitr::include_graphics("~/public-data/quantbio/scRNA-seq/Ankylosating_spondylitis_Liu_2022/Liu_AS_2022.jpg")
```

Data for this analysis was taken from [here](#https://www.nature.com/articles/s41591-021-01323-8) 

<br>

**Figure 1)** from `r params$analysed_dataset`. Cell types and subsets among PSA, PSO, and healthy individuals. (A) UMAP of SCTransform-normalized RNA expression integrated with ADT expression, colored by cell subset. (B) Mean percentages of each cell type within the total PBMCs of each subject. Error bars indicate standard error of the mean; * indicates both Wilcoxon and FDR-adjusted Kruskall-Wallis p-values < 0.05.
