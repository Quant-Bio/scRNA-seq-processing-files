...
seurat_analysed <- CreateSeuratObject(seurat_analysed@assays$RNA@counts, meta.data = seurat_analysed@meta.data,
...
## 1.4 - Write to file
The QC is done, the file is save on `r params$qcs_save_file`.
