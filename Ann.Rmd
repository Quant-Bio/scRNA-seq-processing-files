...
if(!exists("seurats")){
  seurats = readRDS(paste0(gsub(".rds","",params$dir_seurat),params$qcs_save_name,".rds"))
}
```
...
## 2.4 - Write to file
The annotation is done, the file is save on **_`r paste0(gsub(".rds","",params$dir_seurat),params$anno_save_name,".rds")`_**.

```{r, include=FALSE, eval=params$anno_save}
### Merge it and write final object
write_rds(seurats, file=paste0(gsub(".rds","",params$dir_seurat),params$anno_save_name,".rds"))
```
